...
def display_text () :
    ...
    if tab_button:
        ...
        fig = px.bar(pdf, y=x='Phishing Characterstic', y='Probability', color='Probability', color_continuous_scale=px.colors.sequential.Oryel,
                     labels={'Probability':'Probability of Phishing'}, height=400, orientation='h')
